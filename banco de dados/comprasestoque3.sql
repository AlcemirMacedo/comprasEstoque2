...
-- Copiando estrutura do banco de dados para comprasestoque
CREATE DATABASE IF NOT EXISTS `comprasestoque` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `comprasestoque`;

-- Copiando estrutura para tabela comprasestoque.almoxarifado
...
-- Copiando dados para a tabela comprasestoque.almoxarifado: ~11 rows (aproximadamente)
...
-- Copiando estrutura para tabela comprasestoque.bancos
...
-- Copiando dados para a tabela comprasestoque.bancos: 252 rows
...
INSERT INTO `bancos` (`cod`, `banco`) VALUES
	...
	(34, '034 - BANCO DO ESTADO DO AMAZONAS S.A'),
...
-- Copiando estrutura para tabela comprasestoque.categoria
CREATE TABLE IF NOT EXISTS `categoria` (
  `idcategoria` int NOT NULL AUTO_INCREMENT,
  `descricao_cat` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`idcategoria`)
) ENGINE=MyISAM AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Copiando dados para a tabela comprasestoque.categoria: 24 rows
/*!40000 ALTER TABLE `categoria` DISABLE KEYS */;
INSERT INTO `categoria` (`idcategoria`, `descricao_cat`) VALUES
	(1, 'ALIMENTICIO'),
...
-- Copiando estrutura para tabela comprasestoque.centrodeconsumo
CREATE TABLE IF NOT EXISTS `centrodeconsumo` (
...
INSERT INTO `centrodeconsumo` (`id`, `nome`, `idresponsavel`) VALUES
	...
	(2, 'SECRETARIA MUNICIPAL DE ADMINISTRAÇÃO', 2),
	(3, 'SECRETARIA MUNICIPAL DE PRODUÇÃO', 1);
/*!40000 ALTER TABLE `centrodeconsumo` ENABLE KEYS */;

-- Copiando estrutura para tabela comprasestoque.cidade
CREATE TABLE IF NOT EXISTS `cidade` (
  `id` int NOT NULL,
  `nome` varchar(120) DEFAULT NULL,
  `ufid` int DEFAULT NULL,
  `ibge` int DEFAULT NULL,
  KEY `uf_fk` (`ufid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3 COMMENT='Municipios das Unidades Federativas';

-- Copiando dados para a tabela comprasestoque.cidade: 5.595 rows
/*!40000 ALTER TABLE `cidade` DISABLE KEYS */;
INSERT INTO `cidade` (`id`, `nome`, `ufid`, `ibge`) VALUES
	(1, 'Afonso Cláudio', 2, 3200102),
	(2, 'Água Doce do Norte', 8, 3200169),
	(3, 'Águia Branca', 3, 3200136),
	(4, 'Alegre', 8, 3200201),
	...
	(809, 'Milhã', 6, 2308351),
	(810, 'Miraíma', 3, 2308377),
	(811, 'Missão Velha', 3, 2308401),
	(812, 'Mombaça', 4, 2308500),
...
-- Copiando estrutura para tabela comprasestoque.estado
CREATE TABLE IF NOT EXISTS `estado` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(75) DEFAULT NULL,
  `uf` varchar(2) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb3 COMMENT='Unidades Federativas';

-- Copiando dados para a tabela comprasestoque.estado: 27 rows
...
-- Copiando estrutura para tabela comprasestoque.fornecedor
CREATE TABLE IF NOT EXISTS `fornecedor` (
  `idfornecedor` int NOT NULL AUTO_INCREMENT,
  `nomefantasia` varchar(100) NOT NULL,
  `razaosocial` varchar(100) NOT NULL,
  `cnpjcpf` varchar(18) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `inscestadual` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `inscmunicipal` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `nomecontato` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `telcontato` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `email` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `site` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `fk_cod_banco` int DEFAULT NULL,
  `agencia` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `numconta` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`idfornecedor`),
  KEY `fk_banco` (`fk_cod_banco`)
...
CREATE TABLE IF NOT EXISTS `funcionarios` (
  ...
  PRIMARY KEY (`funcionarioID`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela comprasestoque.funcionarios: ~14 rows (aproximadamente)
INSERT INTO `funcionarios` (`funcionarioID`, `nome`, `funcao`, `cpf`) VALUES
	...
	(15, 'Alcemir', 'Programador', '669.528.592-68');

-- Copiando estrutura para tabela comprasestoque.movimentacoes
CREATE TABLE IF NOT EXISTS `movimentacoes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `requisicaoid` int DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `requisicao` (
  ...
  `numreq` varchar(10) DEFAULT NULL,
  `datareq` date DEFAULT NULL,
  `dataconc` date DEFAULT NULL,
  `formapagto` varchar(20) DEFAULT NULL,
  `situacao` varchar(20) DEFAULT NULL,
  `licitacao` varchar(50) DEFAULT NULL,
  `formarequisicao` varchar(50) DEFAULT NULL,
...
-- Copiando dados para a tabela comprasestoque.unidademedida: ~28 rows (aproximadamente)

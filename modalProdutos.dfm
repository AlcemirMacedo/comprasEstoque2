object produtosModal: TprodutosModal
  Left = 0
  Top = 0
  ...
  object Panel8: TPanel
    ...
    object unudadeP: TDBLookupComboBox
      Left = 20
      Top = 168
      Width = 159
      Height = 27
      DataField = 'idunidadefk'
      DataSource = DataModule1.DSproduto
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -16
    ...
    object categoriaP: TDBLookupComboBox
      Left = 198
      Top = 168
      Width = 232
      Height = 27
      ...
      ListField = 'descricao_cat'
      ListSource = DataModule1.DScategoria
      ParentFont = False
      TabOrder = 4
    end
